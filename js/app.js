...
const showProducts = (products) => {
    ...
    <img class="product-image" src=${image}></img>
      ...
      <button id="details-btn" onclick="dataLoad(${product.id})" class="btn btn-danger" data-bs-toggle="modal" data-bs-target="#detailsModal">Details</button></div>
      `;
...
// load data for details option 
const dataLoad = singleProductID => {
...
const showDetails = (data) => {
    ...
    <div class='p-3 text-center'> 
        ...
        <p>Details: ${data.description.slice(0,100)}</p>
...
const getInputValue = (id) => {
    const innerNumber = document.getElementById(id).innerText;
    let converted = parseFloat(innerNumber);
    return converted;
};
